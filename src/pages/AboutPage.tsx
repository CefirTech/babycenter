    ...
    <div className="py-12 md:py-16">
      <div className="container max-w-3xl">
        <div className="text-center mb-12">
          <h1 className="font-heading text-3xl md:text-4xl font-bold text-foreground">À propos de MiniChic</h1>
          <p className="text-muted-foreground mt-3 text-lg">L'élégance pour vos enfants, depuis 2020</p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p className="text-foreground/80 leading-relaxed mb-6">
            MiniChic est née d'une passion : habiller les enfants avec style et qualité. Fondée à Abidjan, notre boutique propose une sélection soigneuse de vêtements premium pour enfants de 0 à 16 ans. Chaque pièce est choisie pour son confort, sa durabilité et son élégance.
          </p>
